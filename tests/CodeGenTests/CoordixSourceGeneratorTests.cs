...
namespace TestApp
{
	...
	public class TestRequestHandler : IRequestHandler<TestRequest, string>
	{
        ...
        // Act
        (Compilation compilation, Diagnostic[] diagnostics) = await RunGenerator(source);

        // Assert
        Assert.Empty(diagnostics);

        string? generatedSource = GetGeneratedSource(compilation, "GeneratedHandlerExecutor.g.cs");
...
namespace TestApp
{
    ...
    private async Task<(Compilation, Diagnostic[])> RunGenerator(string source)
    {
        ...
        Diagnostic[] relevantDiagnostics = diagnostics
    ...
    {
        SyntaxTree? generatedTree = compilation.SyntaxTrees
