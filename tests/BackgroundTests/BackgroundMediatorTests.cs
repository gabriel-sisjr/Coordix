...
public class BackgroundMediatorTests
{
    ...
    public async Task Enqueue_Request_Should_Process_In_Background()
    {
        ...
        IBackgroundMediator backgroundMediator = serviceProvider.GetRequiredService<IBackgroundMediator>();
        IHostedService host = serviceProvider.GetRequiredService<IHostedService>();
    ...
    {
        // Arrange
        bool handler1Processed = false;
        bool handler2Processed = false;
        ServiceCollection services = new ServiceCollection();
        services.AddLogging(builder => builder.AddConsole());
        services.AddCoordix();
        services.AddCoordixBackground();
    ...
    {
        // Arrange
        ILogger<BackgroundMediator> logger = new Mock<ILogger<BackgroundMediator>>().Object;
    ...
    public void BackgroundMediator_Constructor_With_Null_Logger_Should_Throw_ArgumentNullException()
    {
        ...
        ChannelWriter<BackgroundJob> channelWriter = channel.Writer;
    ...
    public async Task EnqueueJob_When_Channel_Is_Closed_Should_Catch_And_Log_Error()
    {
        ...
        Mock<ILogger<BackgroundMediator>> loggerMock = new Mock<ILogger<BackgroundMediator>>();
        BackgroundMediator mediator = new BackgroundMediator(channelWriter, loggerMock.Object);
